...
class ServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['addons.commerceml.storages.order_storage'] = static function (Container $app) {
            return new OrderStorage(
                $app['session'],
                self::getDefaultSyncLanguage(),
        ...
        $app['addons.commerceml.commands.export_orders_command_handler'] = static function (Container $app) {
            return new ExportOrdersCommandHandler(
                ...
                self::getImportSettings(),
                self::getLastSyncInfo(['type' => ImportDto::IMPORT_TYPE_ORDERS])
            );
        };
    ...
    public static function isCatalogImportEnabled($company_id = null)
    {
        ...
        return isset($settings['catalog_importer.import_mode']) ? (bool) $settings['catalog_importer.import_mode'] !== 'none' : true;
    }
