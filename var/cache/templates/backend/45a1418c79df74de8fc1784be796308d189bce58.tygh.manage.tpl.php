<?php /* Smarty version Smarty-3.1.21, created on 2021-01-14 11:15:38
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\addons\attachments\views\attachments\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20702060175ffffdaa4deff4-49358018%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45a1418c79df74de8fc1784be796308d189bce58' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\addons\\attachments\\views\\attachments\\manage.tpl',
      1 => 1610437048,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20702060175ffffdaa4deff4-49358018',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ffffdaa518763_06405584',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ffffdaa518763_06405584')) {function content_5ffffdaa518763_06405584($_smarty_tpl) {?><?php
...
$_tmp15=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('content'=>Smarty::$_smarty_vars['capture']['object_group'],'id'=>$_smarty_tpl->tpl_vars['a']->value['attachment_id'],'text'=>$_smarty_tpl->tpl_vars['a']->value['description'],'status'=>$_smarty_tpl->tpl_vars['a']->value['status'],'object_id_name'=>"attachment_id",'table'=>"attachments",'href_delete'=>"attachments.delete?attachment_id=".((string)$_smarty_tpl->tpl_vars['a']->value['attachment_id'])."&object_id=".((string)$_smarty_tpl->tpl_vars['object_id']->value)."&object_type=".((string)$_smarty_tpl->tpl_vars['object_type']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['redirect_url']->value),'delete_target_id'=>"attachments_list",'header_text'=>$_tmp15.": ".((string)$_smarty_tpl->tpl_vars['a']->value['description']),'additional_class'=>"cm-sortable-row cm-sortable-id-".((string)$_smarty_tpl->tpl_vars['a']->value['attachment_id']),'id_prefix'=>"_attachments_",'prefix'=>"attachments",'hide_for_vendor'=>$_smarty_tpl->tpl_vars['hide_for_vendor']->value,'skip_delete'=>$_smarty_tpl->tpl_vars['skip_delete']->value,'no_table'=>"true",'link_text'=>$_smarty_tpl->tpl_vars['edit_link_text']->value,'draggable'=>true), 0);?>
