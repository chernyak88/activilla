<?php /* Smarty version Smarty-3.1.21, created on 2021-01-14 11:16:38
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\product_features\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20948054415ffffde698d846-69192144%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b45a82d67be83c7126aac03bc9a14d016154ed69' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\product_features\\manage.tpl',
      1 => 1610437085,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20948054415ffffde698d846-69192144',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ffffde6ac1db3_06495090',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ffffde6ac1db3_06495090')) {function content_5ffffde6ac1db3_06495090($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\function.script.php';
...
if (!is_callable('smarty_modifier_to_json')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\modifier.to_json.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('name','internal_feature_name_tooltip','storefront_name','group','categories','status','feature','view','group','view','categories','edit','delete','view','status','no_data','new_feature','new_feature','features'));
?>
...
" method="post" name="manage_product_features_form" id="manage_product_features_form">
    ...
    <?php if ($_smarty_tpl->tpl_vars['has_permission']->value) {?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"product_features:bulk_edit")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"product_features:bulk_edit"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

            <?php echo $_smarty_tpl->getSubTemplate ("views/product_features/components/bulk_edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"product_features:bulk_edit"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <table width="100%" class="table table-middle table--relative table-objects table-responsive">
                    ...
                    <tr>
                        <th width="6%" class="left mobile-hide">
                            <?php echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('check_statuses'=>$_smarty_tpl->tpl_vars['product_feature_statuses']->value), 0);?>
