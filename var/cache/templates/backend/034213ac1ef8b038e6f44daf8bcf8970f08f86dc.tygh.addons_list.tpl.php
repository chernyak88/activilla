<?php /* Smarty version Smarty-3.1.21, created on 2021-01-14 12:14:31
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\addons\components\addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45088024860000b777827e4-98075272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '45088024860000b777827e4-98075272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60000b7787a574_82862353',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60000b7787a574_82862353')) {function content_60000b7787a574_82862353($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\modifier.enum.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('name','version','developer','status','manage','settings','tools','settings','licensing_and_upgrades','licensing_and_upgrades','uninstall','refresh','mve_ultimate_or_plus_license_required','mve_ultimate_license_required','ultimate_license_required','install','no_data'));
?>
...
"
                        ...
                        <?php } else { ?>
                            <a class="row-status cm-external-click <?php if (!$_smarty_tpl->tpl_vars['is_editable']->value) {?>no-underline<?php }?> <?php if (!$_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?>cm-promo-popup<?php }?>" <?php if ($_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?>data-ca-external-click-id="opener_group<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8');?>
...
"
                                    data-ca-target-id="addons_list,header_navbar,header_subnav,addons_counter,elm_developer_pages,elm_all_dev_pages"
